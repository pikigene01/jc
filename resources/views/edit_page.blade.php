...
<head>
    ...
    <title>Consultant Edit Page</title>
</head>
    ...
    <div class="container-fluid text-center bg-dark text-secondary py-5 text-uppercase">
        ...
        <div class="row mt-2 justify-content-between">
            ...
            <div class="col-lg-4 ">
                    ...
                    <form method="post" action="/edit/{{$row->Appointment_id }}">
                        @csrf
             ...
             {{-- <button type="button" class="btn btn-info w-100 mb-1 text-uppercase">ENTER YOUR
                ...
                {{-- <input name="name" type="text" class="form-control mb-1" value="{{$row->Consultant_Name}}">

             <button type="button" class="btn btn-info w-100 mb-1 text-uppercase">ENTER YOUR LAST
                        NAME</button> --}}

                {{-- <input name="last_name" type="text" class="form-control mb-1" value="{{$row->Consultant_LastName}}"> --}}

             <button type="button" class="btn btn-info w-100 mb-1 text-uppercase">ENTER YOUR EMAIL
            </button>

                <input name="email" type="email" class="form-control mb-1" value="{{$row->Email}}">

             <button type="button" class="btn btn-info w-100 mb-1 text-uppercase"> DATE AND TIME FOR
                        CONSULTATION </button>

                <input name="date" type="datetime-local" class="form-control mb-1" value="{{$row->DateTime}}">

             <button type="button" class="btn btn-info w-100 mb-1 text-uppercase">WRITE A BRIEF
                        MESSAGE</button>


                    <input name="message" type="text" class="form-control mb-1" value="{{$row->Message}}">

                        <button type="submit" class="btn btn-info w-100 mb-1 text-uppercase">Update Data</button>
                </form>
                @endforeach
            </div>
